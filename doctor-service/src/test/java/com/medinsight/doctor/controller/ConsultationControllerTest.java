...
@WebMvcTest(controllers = ConsultationController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SecurityGlobalConfig.class))
